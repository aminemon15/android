...
public class TampilSemuaBarang extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void tampilBarang(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                TampilSemuaBarang.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilSemuaBarang.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
